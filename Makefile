...
help:
	...
	@echo "  make generate            - Generate synthetic patients and sync to MinIO"
	@echo ""
	@echo "Ingestion Pipeline:"
	@echo "  make ingest_incremental  - Manually trigger the HOURLY automated incremental load"
	@echo "  make ingest_full         - BOOTSTRAP: Full refresh load from S3 (Manual Only)"
	@echo ""
	Transformation:
